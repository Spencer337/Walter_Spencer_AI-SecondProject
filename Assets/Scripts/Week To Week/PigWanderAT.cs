...
namespace NodeCanvas.Tasks.Actions {
	...
	public class PigWanderAT : ActionTask {
        ...
        {
            // Set the pig's destination to a random point within a circle coming out from the pig
            SetDestination();
            EndAction(true);
        }
        ...
        private void SetDestination()
        {
            ...
            {
                Vector3 circleCenter =  agent.transform.position;
